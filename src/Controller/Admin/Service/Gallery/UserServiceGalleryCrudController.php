...
class UserServiceGalleryCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return UserServiceGallery::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield CollectionField::new('userServiceGalleryItems', 'Галерея изображений')
            ->useEntryCrudForm(UserServiceGalleryItemCrudController::class)
            ->hideOnIndex()
            ->setColumns(12)
            ->setRequired(false);
