...
use App\Repository\UserServiceGeographyDistrictRepository;
use DateTime;
...
#[ORM\Entity(repositoryClass: UserServiceGeographyDistrictRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[Vich\Uploadable]
class UserServiceGeographyDistrict
{
    ...
    #[ORM\ManyToOne(targetEntity: UserServiceGeography::class, inversedBy: 'district')]
