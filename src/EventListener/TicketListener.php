...
class TicketListener
{
    ...
    public function onFlush(OnFlushEventArgs $event): void
    {
        ...
        foreach ($uow->getScheduledCollectionUpdates() as $collection) {
            ...
            // Отмечаем ДО записи, а не после — если сама запись ниже
            // спровоцирует вложенный flush() (см. postUpdate() и докблок
            // $addressChangeHandled), его собственный onFlush() должен уже
            // увидеть эту пометку и не повторить обработку заново.
